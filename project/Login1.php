...
<script language="javascript">
            function check(form) { /*function to check userid & password*/
                ...
                if(form.password.value == "123") {
                    window.open('Photo_gallary.php')/*opens the target page while Id & password matches*/
                }
                else {
...
<body>
	...
	<div class="col-md-4"></div>
     ...
     <div style="background-color: #000000; margin-bottom: 20px; margin-top: 250px; padding: 10px 10px 10px 10px;">
        <center >
